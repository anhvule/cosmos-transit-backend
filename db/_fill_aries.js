// db/_fill_aries.js
//
// Reads _aries_<lens>.js (which exports a map name -> description)
// and patches seed_<lens>_aries.js in place by replacing
...
for (const lens of LENSES) {
  const fillsPath = path.join(__dirname, `_aries_${lens}.js`);
  ...
  const seedPath = path.join(__dirname, `seed_${lens}_aries.js`);
