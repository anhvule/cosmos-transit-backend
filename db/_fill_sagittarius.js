// db/_fill_sagittarius.js
//
// Reads _sagittarius_<lens>.js (which exports a map name -> description)
// and patches seed_<lens>_sagittarius.js in place by replacing
...
for (const lens of LENSES) {
  const fillsPath = path.join(__dirname, `_sagittarius_${lens}.js`);
  ...
  const seedPath = path.join(__dirname, `seed_${lens}_sagittarius.js`);
