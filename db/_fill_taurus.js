// db/_fill_taurus.js
//
// Reads _taurus_<lens>.js (which exports a map name -> description)
// and patches seed_<lens>_taurus.js in place by replacing
...
for (const lens of LENSES) {
  const fillsPath = path.join(__dirname, `_taurus_${lens}.js`);
  ...
  const seedPath = path.join(__dirname, `seed_${lens}_taurus.js`);
